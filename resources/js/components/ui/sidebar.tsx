...
function renderAsChild(
    ...
    return (
        <span data-slot={fallbackSlot} {...extraProps} />
    );
}
...
function SidebarMenuButton({
    ...
    const button = asChild ? (
        renderAsChild(children, buttonProps, 'sidebar-menu-button')
    ) : (
...
function SidebarMenuSkeleton({
    ...
    // Lebar tetap (bukan Math.random) agar SSR dan client menghasilkan
    // HTML yang identik dan tidak memicu hydration mismatch.
    const skeletonStyle = {
        '--skeleton-width': '72%',
    } as React.CSSProperties;
...
function SidebarMenuSubButton({
    ...
    if (asChild) {
        return renderAsChild(children, buttonProps, 'sidebar-menu-sub-button');
    }
